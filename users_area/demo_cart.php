    ...
    if (isset($_POST["add"])){
        if (isset($_SESSION["cart"])){
            ...
            if (!in_array($_GET["product_id"],$item_array_id)){
                ...
                echo '<script>window.location="demo_cart.php"</script>';
            }else{
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="demo_cart.php?action=add&id=<?php echo $row["product_id"]; ?>">

                            <div class="product">
                                <img src="<?php echo $row["product_image1"]; ?>" class="img-responsive">
                ...
                if(!empty($_SESSION["cart"])){
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="demo_cart.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span
